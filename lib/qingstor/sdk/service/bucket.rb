...
module QingStor
  ...
  def delete_multiple_objects_input_validate(input)
    input.deep_stringify_keys!
        ...
        input['request_elements']['objects'].each { |x|
  ...
  def put_bucket_acl_input_validate(input)
    input.deep_stringify_keys!
        ...
        input['request_elements']['acl'].each { |x|
      ...
      unless x['grantee'].nil?
        ...
        if x['grantee'].nil?
          ...
          if x['permission'] && !x['permission'].to_s.empty?
            permission_valid_values = ["READ", "WRITE", "FULL_CONTROL"]
            unless permission_valid_values.include? x['permission'].to_s
              raise ParameterValueNotAllowedError.new(
                'permission',
                x['permission'],
  ...
  def put_bucket_cors_input_validate(input)
    input.deep_stringify_keys!
        ...
        input['request_elements']['cors_rules'].each { |x|
  ...
  def put_bucket_lifecycle_input_validate(input)
    input.deep_stringify_keys!
        ...
        input['request_elements']['rule'].each { |x|
  ...
  def put_bucket_notification_input_validate(input)
    input.deep_stringify_keys!
        ...
        input['request_elements']['notifications'].each { |x|
          ...
          unless !x['cloudfunc'].nil? && !x['cloudfunc'].to_s.empty?
            raise ParameterRequiredError.new('cloudfunc', 'notifications')
          end
      ...
      unless x['cloudfunc_args'].nil?
        ...
        unless !x['event_types'].nil? && !x['event_types'].to_s.empty?
          raise ParameterRequiredError.new('event_types', 'notifications')
        end
          ...
          unless !x['id'].nil? && !x['id'].to_s.empty?
            raise ParameterRequiredError.new('id', 'notifications')
          end
  ...
  def put_bucket_policy_input_validate(input)
    input.deep_stringify_keys!
        ...
        input['request_elements']['statement'].each { |x|
